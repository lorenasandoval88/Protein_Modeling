...
Clazz.load (null, "JSV.source.BrukerReader", ["java.io.BufferedInputStream", "$.ByteArrayInputStream", "$.File", "$.FileInputStream", "java.lang.Double", "java.util.Hashtable", "java.util.zip.ZipInputStream", "JU.BinaryDocument", "$.Lst", "JSV.common.Coordinate", "$.Spectrum", "JSV.source.JDXReader", "$.JDXSource"], function () {
c$ = Clazz.decorateAsClass (function () {
this.allowPhasing = false;
Clazz.instantialize (this, arguments);
}, JSV.source, "BrukerReader");
Clazz.makeConstructor (c$, 
function () {
});
Clazz.defineMethod (c$, "readBrukerZip", 
...
var bytes =  Clazz.newByteArray (len, 0);
try {
var pos = 0;
while (len > 0) {
var n = $in.read (bytes, pos, len);
if (n < 0) break;
len -= n;
pos += n;
}
