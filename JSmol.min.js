...
Jmol._version || (Jmol = function (a) {
    var m = function (a) {
        ...
        m = {
            _version: "$Date: 2021-05-26 21:16:02 -0500 (Wed, 26 May 2021) $",
            _alertNoBinary: !0,
    ...
    m._useDataURI = !m._isMsie && !m._isEdge;
...
(function (a, m) {
    ...
    a._registerApplet = function (b, c) {
        return window[b] = a._applets[b] = a._applets.master = a._applets[b + "__" + a._syncId + "__"] = c
    };
...
(function (a) {
    ...
    a._jsSetPrototype = function (b) {
        ...
        b._createCanvas = function (b, c, e) {
            ...
            this._deferApplet || (a._document ? (a._documentWrite(e), this._newCanvas(!1), e = "") : (this._deferApplet = !0, e += "<img width=0 height=0 src=. onerror=" + b + "._cover(false) >"));
            e += a._getWrapper(this, !1);
            c.addSelectionOptions && (e += a._getGrabberOptions(this));
        ...
        b.__startAppletJS = function (b) {
            ...
            b._j2sFullPath = e.substring(0, e.length - 1);
            c.put("codePath", e);
    ...
    window["j2s.clazzloaded"] || (window["j2s.clazzloaded"] = !0, window["j2s.object.native"] = !0, Clazz = {
        ...
        a._innerFunctions.getDeclaredMethods = a._innerFunctions.getMethods = function () {
            var a = [],
                b = this.prototype,
                c;
            for (c in b) "function" == typeof b[c] && !b[c].__CLASS_NAME__ && a.push(new java.lang.reflect.Method(this, c, [], java.lang.Void,
        ...
        a._innerFunctions.getDeclaredMethod = a._innerFunctions.getMethod = function (a) {
            ...
            b = this;
            for (c in b)
                if (a == c && "function" == typeof b[c] && !b[c].__CLASS_NAME__) return new java.lang.reflect.Method(this, c, [], java.lang.Void, [], java.lang.reflect.Modifier.PUBLIC | java.lang.reflect.Modifier.STATIC);
            return null
        };
            ...
            switch (null == a ? 0 : a.length) {
                ...
                case 4:
                    return new this(a[0],
                        a[1], a[2], a[3]);
                default:
                    for (var b = "new " + this.__CLASS_NAME__ + "(", c = 0; c < a.length; c++) b += (0 == c ? "" : ",") + "a[" + c + "]";
                    return eval(b + ")")
            }
        };
        ...
        (function (a, b) {
            ...
            b.updateNodeForFunctionDecoration =
                function (a) {
            ...
            var d = new x,
                ...
                f = -1 != l.indexOf("gecko");
            if (q && (j = 1, q = l.indexOf("opera/"), -1 != q)) {
                var t = 9;
                try {
            ...
            var C = function (a) {
                ...
                D = {},
                I = 0;
            b.loadPackageClasspath = function (a, c, d, e, f, h) {
                f || (f = 0);
                e || (e = null);
                h || (h = 0);
                var j = d && D["@" + a];
                ...
                if (a instanceof Array)
                    ...
                    switch (a) {
                        case "java.*":
                            a = "java";
                        case "java":
                            c && (f = "@net.sf.j2s.ajax", D[f] || (D[f] = c), f = "@net.sf.j2s", D[f] || (D[f] = c));
                            break;
                        case "swt":
                            a = "org.eclipse.swt";
                            break;
            ...
            a.loadClass = function (c, d, e) {
                ...
                return c && b.loadClass(c, d, !0, e, 1)
            };
                ...
                if (!h && (I && c.lastIndexOf(".package") != c.length - 8 || 0 != c.indexOf("java.") && !isClassDefined(da))) La.push([c, f]), System.out.println("loadclass-queuing" + c + da + " " + isClassDefined(da));
                    ...
                    if (!l)
                        ...
                        for (j = E.length; 0 <= --j;)
                            ...
                            for (j = E.length; 0 <= --j && !E[j].isPackage;) E[j + 1] = E[j];
                            E[++j] = l
                        } else c && E.push(l);
                        if (!c) {
                            var s = !1;
            ...
            b.registerPackages = function (c, d) {
                for (var e = b.getClasspathFor(c + ".*", !0), f = 0; f < d.length; f++) window.Clazz && a.declarePackage(c + "." + d[f]), b.loadPackageClasspath(c + "." + d[f], e)
            };
            b.getClasspathFor = function (c, d, e) {
                ...
                if (!f || d || e) {
                    ...
                    if (f) {
                        ...
                        for (j =
                            c.length + 2; 0 <= (j = c.lastIndexOf(".", j - 2)) && !(h = D["@" + c.substring(0, j)]););
                        d || (c = c.replace(/\./g, "/"))
                    }
                    null == h && (h = window.Clazz && a.binaryFolders && a.binaryFolders.length ? a.binaryFolders[0] : b.binaryFolders && b.binaryFolders.length ? b.binaryFolders[0] : "j2s");
            ...
            a._4Name = function (c, d, e) {
                ...
                d = m._isAsync && d ? d._restoreState(c,
                    e) : null;
                if (1 == d) return null;
            ...
            var V = function (c, d, f, j, l) {
                    ...
                    if (M && !sa) {
                        ...
                        success: ua(d, !1, l),
                        error: ua(d, !0, l)
                    }, h++, j ? setTimeout(c.success, 0) : m.$ajax(c)
                },
                ua = function (c, d, e) {
                    a.getStackTrace();
                    return function () {
                ...
                ta = function (c, f) {
                    ...
                    if (l) {
                        ...
                        if (b.keepOnLoading) {
                            ...
                            else if (0 != E.length) m = E.shift(), !e[m.path] || 0 != E.length || !ha || m.musts.length || m.optionals.length ? (Ja(d, m, !0), V(m, m.path, m.requiredBy, !1)) : ha && (ha = !1);
                            ...
                            if (!(q || 0 < h)) {
                                ...
                                for (q = 0; 2 > q; q++)
                                    for (r = null;
                                        (m =
                                            l[q](x.STATUS_DECLARED)) && r !== m;) updateNode(r = m);
                                r = [];
                                for (q = 0; 2 > q; q++)
                ...
                na = function (a, c) {
                    ...
                    if (0 <= f) {
                        if (b._checkLoad) {
                            var h;
                            System.out.println("cycle found loading " + c + " for " + a)
                        }
                        for (; f < e; f++) {
                            var j = d[f];
            ...
            updateNode = function (a) {
                if (!a.name || a.status >= x.STATUS_LOAD_COMPLETE) Da(a);
                else {
                    var c = !0;
                    ...
                    if (c) {
                        ...
                        c = x.STATUS_DECLARED;
                        if (0 == a.optionals.length && 0 == a.musts.length ||
                            a.status > x.STATUS_KNOWN && !a.declaration || Ta(a.musts, x.STATUS_LOAD_COMPLETE) && Ta(a.optionals, x.STATUS_LOAD_COMPLETE)) {
            ...
            var Ta = function (a,
                ...
                Ea = function (a, b) {
                    var c;
                    return b.name == a ? b : (c = $a(a, b.musts)) || (c = $a(a, b.optionals)) ? c :
                        null
                },
                $a = function (a, b) {
                ...
                R = function (a, c, e, f) {
                    if (c instanceof Array) {
                        ...
                        b._checkLoad && !b._classPending[c] && (b._classPending[c] = 1, 0 == b._classCountPending++ && (b._classCountOK = 0), System.out.println("Loading class " + c));
                        h = L["#" + c];
                        h || (h = (h = H(c)) ? h : new x, h.name = c, h.path = D["#" + c] || "unknown", X(h.path, c, h), h.status = x.STATUS_KNOWN, Ja(d, h, !1));
                        ja(h, a, !0);
                        5 == arguments.length &&
                            f && (f.status = h.status, f.clazzList = arguments[4]);
            ...
            b.getJ2SLibBase = function () {
                ...
                return a ? a.base + ("." == a.alias ? "" : (a.alias ? a.alias : a.version ? a.version : "1.0.0") + "/") : null
            };
            var sa = !0,
                M = !1,
                W = -1;
            ...
            b.setLoadingMode = function (a, c) {
                ...
                "string" == typeof a ? (a = a.toLowerCase(),
                    0 <= a.indexOf("script") ? e = !1 : a.indexOf("async"), d = !1) : a & b.MODE_SCRIPT ? e = !1 : d = !(a & b.MODE_SYNC);
                M = e;
                W = (sa = d) && 0 <= c ? c : -1;
                return d
            };
        ...
        aa.showStatus = function (a, b) {
            if (!O) {
                ...
                c.id = "_Loader-status";
                c.style.cssText = "position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:" + (window["j2s.lib"].monitorZIndex || 1E4) + ";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";
                c.onmouseover = ub;
                O = c;
        ...
        C.linesCount = 0;
        C.metLineBreak = !1;
        C.createConsoleWindow = function () {
            ...
            function (a, b) {
                ...
                for (var h = a.split(/\r\n|\r|\n/g), d = 0, j = h.length - 1; d <= j; d++) {
                    ...
                    if (C.metLineBreak || 0 == C.linesCount || 1 > c.childNodes.length) l = document.createElement("DIV"), c.appendChild(l), l.style.whiteSpace = "nowrap", C.linesCount++;
                        ...
                        l = c.childNodes[c.childNodes.length - 1]
                    } catch (m) {
        ...
        ba.err.write = function (a, b, c) {
            ba.err.print(String.instantialize(a).substring(b,
                b + c))
        }
    }(Clazz, Jmol))
};
